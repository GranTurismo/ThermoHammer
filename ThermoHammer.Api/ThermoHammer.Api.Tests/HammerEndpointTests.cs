...
public class MockGcamatorHandler : HttpMessageHandler
{
    ...
    {
        { "25031111C", ("Xiaomi", "Xiaomi 17 Pro max") }, // API returns full string starting with manufacturer
        { "2210132C", ("Xiaomi", "13 Pro") },
        { "24031PN0DC", ("Xiaomi", "14 Ultra") },
        { "SM-S918B", ("Samsung", "Samsung Galaxy S23 Ultra") }, // API returns full string starting with manufacturer
